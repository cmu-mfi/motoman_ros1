...
bool YK_Interface::getPose(yk_msgs::GetPoseStamped::Request &req,
...
void YK_Interface::goToPoseCallback(const yk_tasks::GoToPoseGoalConstPtr &goal)
{
	ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
void YK_Interface::goToJointsCallback(const yk_tasks::GoToJointsGoalConstPtr &goal)
{
	ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
